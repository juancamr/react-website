...
$(builddir)/libuvwasi.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/libuvwasi.a: LIBS := $(LIBS)
$(builddir)/libuvwasi.a: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/libuvwasi.a: TOOLSET := $(TOOLSET)
$(builddir)/libuvwasi.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(builddir)/libuvwasi.a
# Add target alias
.PHONY: uvwasi
uvwasi: $(builddir)/libuvwasi.a
