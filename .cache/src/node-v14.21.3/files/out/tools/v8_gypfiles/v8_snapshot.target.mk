...
quiet_cmd__Users_tiims_Documents_web_react_website__cache_src_node_v14_21_3_files_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION generating: "$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc" "$(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S" $@
cmd__Users_tiims_Documents_web_react_website__cache_src_node_v14_21_3_files_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/tools/v8_gypfiles; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot" --turbo_instruction_scheduling "--target_os=mac" "--target_arch=arm64" --startup_src "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc" --embedded_variant Default --embedded_src "$(obj).$(TOOLSET)/v8_snapshot/geni/embedded.S" --no-native-code-counters
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: export SDKROOT := /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: export XCODE_VERSION_ACTUAL := 1431
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: TOOLSET := $(TOOLSET)
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S: 5a231d1b63631a52c81086fb75097976ccc74346.intermediate
	@:
.INTERMEDIATE: 5a231d1b63631a52c81086fb75097976ccc74346.intermediate
5a231d1b63631a52c81086fb75097976ccc74346.intermediate: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,touch)
	$(call do_cmd,_Users_tiims_Documents_web_react_website__cache_src_node_v14_21_3_files_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
action__Users_tiims_Documents_web_react_website__cache_src_node_v14_21_3_files_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
...
$(OBJS): | $(action__Users_tiims_Documents_web_react_website__cache_src_node_v14_21_3_files_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(builddir)/libv8_snapshot.a: | $(action__Users_tiims_Documents_web_react_website__cache_src_node_v14_21_3_files_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__Users_tiims_Documents_web_react_website__cache_src_node_v14_21_3_files_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(builddir)/mksnapshot $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp
